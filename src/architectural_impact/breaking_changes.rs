...
use crate::tree_sitter::{FunctionInfo, ClassInfo};
...
pub fn assess_change_impact(change_type: &BreakingChangeType, component: &str) -> ImpactLevel {
    match change_type {
        ...
        BreakingChangeType::InterfaceChanged => ImpactLevel::Project,
        ...
        BreakingChangeType::StructureChanged => ImpactLevel::Local,
        
        BreakingChangeType::FunctionAdded |
        BreakingChangeType::ModuleStructureChanged => ImpactLevel::Minimal,
    }
}
...
mod tests {
    ...
    fn test_suggestion_generation() {
        let suggestions = generate_suggestions(&BreakingChangeType::FunctionRemoved, "old_function");
