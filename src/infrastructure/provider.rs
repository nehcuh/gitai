...
use super::container::{ServiceContainer, ServiceProvider, ContainerError};
...
impl ProviderFactory {
    ...
    pub async fn register_default_providers(&self, container: &ServiceContainer
        ...
        // 注册配置提供者
        container.register_singleton(ConfigProvider::new(self.config.clone())).await;
        
        // 注册Git服务提供者
        container.register_singleton(GitServiceProvider::new(self.config.clone())).await;
        
        // 注册AI服务提供者
        container.register_singleton(AiServiceProvider::new(self.config.clone())).await;
        
        // 注册缓存服务提供者
        container.register_singleton(CacheServiceProvider::new(self.config.clone())).await;
    ...
    pub async fn register_environment_providers(&self, 
        ...
        match environment {
            ...
            _ => {
                return Err(ContainerError::ServiceCreationFailed(
