...
use crate::domain_errors::ConfigError;
...
impl AiConfig {
    /// 验证配置
    pub fn validate(&self) -> std::result::Result<(), crate::domain_errors::ConfigError> {
...
pub trait ConfigValidator {
    /// 验证配置
    fn validate(&self) -> std::result::Result<(), crate::domain_errors::ConfigError>;
}
